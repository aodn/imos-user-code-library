...
This document will present the IMOS Hourly aggregated times series product. It contains: 
...
First we need to extrac the variable values and store it in a data frame. We're interested in `TIME`, `TEMP`, `DEPTH`, and `instrument_index`
