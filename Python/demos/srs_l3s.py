...
pcolor(lon_mesh,lat_mesh ,land != 2,cmap=get_cmap('gray')) # see srsL3S_DATA.variables.l2p_flags.flag_meanings for more information: 2 == land

pcolor(lon_mesh,lat_mesh ,sst)
title( srs_L3S_DATA.title + '-' +  srs_L3S_DATA.start_time )
